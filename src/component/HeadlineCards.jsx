  ...
  return (
    <div className="max-w-[1240px]  mx-auto p-4 py-12 grid md:grid-cols-3 gap-6 ">
      ...
      <div className=" rounded-xl relative">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.pexels.com/photos/1603901/pexels-photo-1603901.jpeg?auto=compress&cs=tinysrgb&w=400"
          alt=""
        />
      </div>
      ...
      <div className=" rounded-xl relative">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.pexels.com/photos/936611/pexels-photo-936611.jpeg?auto=compress&cs=tinysrgb&w=400"
          alt=""
        />
      </div>
    </div>
